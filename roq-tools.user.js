...
(function() {
  ...
  function mount() {
    ...
    bar.innerHTML = `<span class="title">RoQ Tools</span><button id="map">🗺 Mapa</button><button id="opt">⚗ Optymalizator</button>`;
  ...
  function openOptimizer() {
    ...
    optPanel.innerHTML = `<div class="head"><span>⚗ RoQ — Optymalizator</span><span class="close">×</span></div>
